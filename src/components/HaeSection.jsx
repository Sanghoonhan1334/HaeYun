// src/components/HaeSection.jsx
import { useContext } from 'react';
import { LanguageContext } from '../contexts/LanguageContext';
import { translations, englishTranslations } from '../translations';

export default function HaeSection() {
  const { currentLang } = useContext(LanguageContext);
  const t = translations[currentLang];
  const en = englishTranslations;

  return (
    <section id="hae" className="min-h-screen flex items-center justify-center px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-neutral-800 p-4 rounded-lg border border-neutral-200 dark:border-neutral-700">
              ...
              <div className="w-full h-64 bg-neutral-200 dark:bg-neutral-600 rounded overflow-hidden relative group cursor-pointer">
                <img 
                  src="https://img.youtube.com/vi/Lc3REZW9NsE/maxresdefault.jpg" 
                  alt="HAE YouTube 영상 썸네일" 
                  className="w-full h-full object-cover"
                />
                {/* 플레이 버튼 오버레이 */}
                ...
                {/* 클릭 시 YouTube로 이동 */}
                <a 
                  href="https://youtu.be/Lc3REZW9NsE" 
                  target="_blank" 
